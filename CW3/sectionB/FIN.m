function [Shortest_Route, Shortest_Length] = optimized_ACO_TSP()
...
% First figure: Route plot
figure('Position', [100, 100, 600, 400]);  % Optional: set figure position and size
...
% Second figure: Convergence plot
figure('Position', [700, 100, 600, 400]);  % Optional: set figure position and size
...
% 调用优化的ACO-TSP算法
[Shortest_Route, Shortest_Length] = optimized_ACO_TSP();
